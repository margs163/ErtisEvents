...
export default function Recommendations() {
  ...
  return (
    <section className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 px-5 mt-8 lg:px-40 lg:mt-20">
...
function RecommendItem({ data }: { data: EventType }) {
  const [liked, setLiked] = useState(false);

  return (
    <div className="flex flex-col space-y-6 lg:space-y-9 p-6 lg:p-8 rounded-2xl bg-white lg:rounded-3xl border-2 shadow-md shadow-gray-200 relative">
      {data.s3Url && (
        <Image
          src={data.s3Url}
          alt="img"
