...
export default function Hero() {
  ...
  return (
    <section className="space-y-4 bg-blue-500 [background:linear-gradient(to_bottom,_transparent_65%,_#3b82f6_65%)] mb-0">
      <div className="max-w-350 space-y-4 mx-auto">
        <div className="space-y-0 px-8 lg:px-20 relative z-20">
          <div className="flex gap-8 lg:gap-20 items-start lg:items-center mb-0">
            <h1 className=" text-[3.2rem] lg:text-[8rem] leading-none font-extrabold text-white scale-x-109 lg:scale-x-110">
              ВСЕ
            </h1>
          ...
          <h1 className="text-[2.65rem] lg:text-[8rem] lg:text-9xl leading-[1] font-extrabold text-white scale-x-105 lg:scale-x-110 lg:pl-6">
            МЕРОПРИЯТИЯ
          </h1>
        </div>
        <div className=" h-40 lg:h-100 relative -bottom-14 w-full">
          <Image
            src={concert}
            alt="img"
            className="max-w-88 lg:w-340 lg:max-w-340 h-48 lg:h-170 object-cover rounded-3xl lg:rounded-[3rem] relative -top-24 lg:-top-40 mx-auto z-0 shadow-xl"
          />
          <div className="absolute -top-30 lg:-top-24 right-4 lg:right-10 z-20">
            <Image
              src={badge}
              alt="badge"
            ...
            />
            <h2 className="text-[14px] lg:text-[2rem] max-w-20 lg:max-w-50 leading-none top-10 lg:top-32 lg:right-14 right-2.5 text-center font-extrabold text-white absolute">
              СТАТЬ ХОСТОМ
            </h2>
          </div>
