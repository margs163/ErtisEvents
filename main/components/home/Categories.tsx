...
export default function Categories() {
  return (
    <div className=" space-y-8 lg:space-y-24 bg-linear-to-b from-blue-500 from-0% to-50% to-blue-50 px-4 py-20 lg:px-32 lg:py-36">
      <section className=" max-w-350 space-y-8 lg:space-y-24 mx-auto">
